...
```sh
bash <(wget -qO- https://raw.githubusercontent.com/boostsebastian/linux-bootstrap/master/bootstrap) 2>&1 | tee ~/bootstrap.log
```

Want to read through the script first?

```sh
wget -qO- https://raw.githubusercontent.com/boostsebastian/linux-bootstrap/master/bootstrap > bootstrap
less bootstrap
